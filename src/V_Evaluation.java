...
public class V_Evaluation {
	...
	private void initialize() {
		...
		JLabel ID = new JLabel("2020 - 103235");
		...
		JRadioButton rdbtnNewRadioButton_1_2_2 = new JRadioButton("");
		...
		JRadioButton rdbtnNewRadioButton_1_1_2_1 = new JRadioButton("");
		...
		JRadioButton rdbtnNewRadioButton_1_2_2_1 = new JRadioButton("");
		...
		JRadioButton rdbtnNewRadioButton_1_3_2_1 = new JRadioButton("");
